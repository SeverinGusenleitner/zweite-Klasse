...
export class CircleFish extends Fish{
  ...
  constructor(aquarium: HTMLElement, src: string, startX: number, startY: number ) {
...
export class SquareFish extends Fish{
    ...
    private traveledX:number = 0;
    private traveledY:number = 0;
    
    update(){
        this.x +=this.speedX;
        this.y += this.speedY;
        this.traveledX += this.speedX;
        this.traveledY += this.speedY;
        if(this.traveledX>100){
            this.traveledX = 0;
            this.speedY = this.speedX;
            this.speedX = 0;
        }
        else if(this.traveledY>100){
            
            this.traveledY = 0;
            this.speedX = -this.speedY;
            this.speedY= 0;
        }
        else if(this.traveledX<-100){
            this.traveledX = 0;
            this.speedY = this.speedX;
            this.speedX = 0;
        }
